...
// ACHIEVEMENTS
//
// Each achievement supports the following fields:
//   id            — unique key
//   title         — display name
//   description   — short description
//   icon          — emoji icon
//   tier          — 'bronze' | 'silver' | 'gold'
//   max           — stat threshold required to claim
//   statKey       — which pet stat to measure against max
//   rewardPetUnlock — (optional) petId to unlock as reward when claimed
//
// Runtime state fields (stored in chrome.storage, NOT here):
//   claimable     — true when stat threshold is met but not yet claimed
//   unlocked      — timestamp when user clicked CLAIM (permanent)
//
const ACHIEVEMENTS = [
  {
    id: 'first-pet',
  ...
  },
  {
    id: 'dreamer',
    title: 'Dreamer',
    description: 'Let your pet sleep 10 times',
    icon: '💤',
    tier: 'bronze',
    max: 10,
    statKey: 'sleepCount',
  ...
  },
  {
    id: 'collector',
    title: 'Collector',
    description: 'Own 3 different pet types',
    icon: '📦',
    tier: 'silver',
    max: 3,
    statKey: 'uniquePets',
    rewardPetUnlock: 'hamster'      // Unlocks the Hamster pet
  },
  {
    id: 'gourmet',
    title: 'Gourmet',
  ...
  },
  {
    id: 'energizer',
    title: 'Energizer',
    description: 'Keep your pet\'s energy above 90%',
    icon: '⚡',
    tier: 'silver',
    max: 90,
    statKey: 'energy',
  ...
  },
  {
    id: 'night-owl',
    title: 'Night Owl',
    description: 'Be active for 10 hours total',
    icon: '🦉',
    tier: 'gold',
    max: 36000000,
    statKey: 'totalPlayTime',
    rewardPetUnlock: 'dragon'       // Unlocks the Dragon pet
  },
  {
    id: 'best-friend',
    title: 'Best Friend',
  ...
  },
  {
    ...
    max: 100,
    statKey: 'mood',
    rewardPetUnlock: 'ghost'        // Unlocks the Pixel Ghost pet
  }
];
